...
public class Lists {
    ...
    protected java.util.List<com.liferay.aws.client.List> list;
     ...
     * {@link com.liferay.aws.client.List }
     * 
     * 
     */
    public java.util.List<com.liferay.aws.client.List> getList() {
        if (list == null) {
            list = new ArrayList<com.liferay.aws.client.List>();
        }
        return this.list;
    }
